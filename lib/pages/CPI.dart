...
import 'package:gtu_marks/pages/CPI_Result.dart';
import 'package:gtu_marks/pages/HomePage.dart';
import 'package:hexcolor/hexcolor.dart';

class CPI_Page extends StatefulWidget {
  @override
  State<CPI_Page> createState() => _CPI_PageState();
}

class _CPI_PageState extends State<CPI_Page> {
  //for storing data
  ...
  //share all 2 data into CPIResult Page
  sendItem(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => CPIResult(
                            ...
                            setState(() {
                              if ((_formKeyEarnedGradePoint.currentState!
                                  ...
                                  (_formKeyEarnedCreaditPoint.currentState!
                                      .validate())) {
                                //send all data into the CPI Result Page and move to CPI result page
                                sendItem(context);
                              }
                            });
                          },
